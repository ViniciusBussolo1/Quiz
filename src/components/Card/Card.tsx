...
export function Card({ answers, onClick }: CardProps) {
  return (
    <div
      className="max-w-[15.625rem] w-full h-[18.75rem] relative py-[2.875rem] px-8 bg-gray-5 hover:bg-gray-4 rounded-lg border-gray-3 border-t-[0.2rem] border-r-[0.2rem] border-b-[0.399rem] border-l-[0.2rem] cursor-pointer"
      onClick={onClick}
    >
